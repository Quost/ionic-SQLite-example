  ...
  function srcAppServicesDatabaseServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let DatabaseService = class DatabaseService {
      ...
      updateDeveloper(dev) {
        ...
        return this.database.executeSql("UPDATE developer SET name = ?, skills = ?, img = ? WHERE id = ".concat(dev.id), data).then(data => {
          this.loadDevelopers();
        });
      }
    ...
    DatabaseService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Injectable"])({
      providedIn: 'root'
